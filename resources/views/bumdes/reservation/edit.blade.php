    ...
    <div class="row">
        ...
        <div class="card shadow col-8 mb-4 mx-auto">
            <div class="card-header py-3 text-center">
                <h6 class="m-0 font-weight-bold text-primary">Form Ubah Data Penyewaan</h6>
            </div>
            <div class=" card-body">
                <form action="{{ route('update-reservation', $data->id) }}" method="post" id="inputForm"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control @error('location') is-invalid @enderror" id="location"
                            name="location">{{ old('location') ? old('location') : $data->location }}</textarea>
                        @error('location')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('start_reservation_date') ? old('start_reservation_date') : $data->start_reservation_date }}">
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="form-control @error('end_reservation_date') is-invalid @enderror"
                                    ...
                                    value="{{ old('end_reservation_date') ? old('end_reservation_date') : $data->end_reservation_date }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('package') is-invalid @enderror" id="package"
                            name="package" value="{{ old('package') ? old('package') : $data->package }}">
                        @error('package')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('payment') is-invalid @enderror" id="payment"
                            name="payment" value="{{ old('payment') ? old('payment') : $data->payment }}"
                            data-type="currency">
                        @error('payment')
                            <div class="invalid-feedback">
                                {{ $message }}
