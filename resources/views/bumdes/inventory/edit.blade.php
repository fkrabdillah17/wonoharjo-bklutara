...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Data Inventaris</h1>
    </div>
    @if (session('status'))
    ...
    <div class="row">
        ...
        <div class="card shadow col-8 mb-4 mx-auto">
            ...
            <div class=" card-body">
                <form action="{{ route('update-inventory', $data->id) }}" method="post" id="inputForm"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('source') is-invalid @enderror" id="source"
                            name="source" value="{{ old('source') ? old('source') : $data->source }}">
                        @error('source')
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oldName" name="oldName" value="{{ $data->name }}">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('amount') is-invalid @enderror" id="amount"
                            name="amount" value="{{ old('amount') ? old('amount') : $data->amount }}">
                        @error('amount')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('condition') is-invalid @enderror" id="condition"
                            name="condition" value="{{ old('condition') ? old('condition') : $data->condition }}">
                        @error('condition')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('assets/img/inventory/' . $data->picture) }}" width="100%" alt="">
                    </div>
