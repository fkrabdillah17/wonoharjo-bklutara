...
<head>
    ...
    {{-- Custom CSS --}}
    <link href="{{ URL::asset('assets/css/mycss.css?v=1.0.1') }}" rel="stylesheet">
    {{-- Custom JS --}}
...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper">
        @include('layouts.bumdes.sidebar')
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                @include('layouts.bumdes.topbar')
                <div class="container-fluid">
                    @yield('content')
                </div>
            </div>
            @include('layouts.bumdes.footer')
        </div>
    </div>
    <!-- End of Page Wrapper -->
