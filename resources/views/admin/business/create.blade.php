...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Usaha Desa</h1>
    </div>
    @if (session('status'))
    ...
    <div class="row">
        ...
        <div class="card shadow col-8 mb-4 mx-auto">
            <div class="card-header py-3 text-center">
                <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Usaha</h6>
            </div>
            <div class="card-body">
                <form method="post" action="/admin/business" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('field') is-invalid @enderror" id="field" name="field">
                            <option value="{{ old('field') }}">{{ old('field') ? old('field') : '-Pilihan-' }}
                            </option>
                    ...
                    <div class="form-group" id="rowContent">
                        <label for="thumbnail" class="required">Foto Tempat Usaha</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control @error('whatsapp') is-invalid @enderror" id="whatsapp"
                                value="{{ old('whatsapp') }}" name="whatsapp" placeholder="8xx-xxxx-xxxx">
                        </div>
                        @error('whatsapp')
                            <div class="invalid-feedback">
                                {{ $message }}
