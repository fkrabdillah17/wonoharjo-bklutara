...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Profil Desa</h1>
    </div>
    @if (session('status'))
        ...
        <script type="text/javascript">
            ...
            function option() {
                ...
                if (kategori == "sejarah" || kategori == "visimisi") {
                    ...
                    showButton.style.display = "";
                    replaceContent.innerHTML =
                        `<label for="file ">File Struktur</label> <input type="file" class="form-control-file @error('file') is-invalid @enderror" id="file" name="file">
                        @error('file')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
